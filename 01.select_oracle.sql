...
select ename 이름, (sal * 12) + NULLIF(comm, 0) as 연봉 from emp;
...
--MONTHS_BETWEEN(TO_DATE('1980-12-17', 'YYYY-MM-DD'), TO_DATE('1981-09-28', 'YYYY-MM-DD'));
--where hiredatce between '1980-12-17' and '1981-09-28'
--between() '1980-12-17' and '1981-09-28'
